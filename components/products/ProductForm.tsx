                        ...
                        <div className="space-y-3 p-6 rounded-3xl bg-amber-500/5 border border-amber-500/20 shadow-inner group/input focus-within:bg-amber-500/10 transition-colors">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className="h-14 bg-background/50 border-amber-500/20 rounded-2xl pl-10 pr-6 font-mono font-black text-lg focus:ring-amber-500 transition-all text-amber-500"
                                    placeholder="0.00"
                                />
                        ...
                        <div className="space-y-3 p-6 rounded-3xl bg-emerald-500/5 border border-emerald-500/20 shadow-inner group/input focus-within:bg-emerald-500/10 transition-colors">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className="h-14 bg-background/50 border-emerald-500/20 rounded-2xl pl-10 pr-6 font-mono font-black text-lg focus:ring-emerald-500 transition-all text-emerald-500"
                                    placeholder="0.00"
                                />
