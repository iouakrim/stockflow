            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="glass-card rounded-[2.5rem] p-8 border border-primary/10 relative overflow-hidden group">
                        ...
                        <div className="space-y-6 relative">
                            <div className="space-y-4">
                                <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60">Partner Communications</h4>
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4 group/item">
                                        ...
                                        <div className="min-w-0">
                                            <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground/40">Email Protocol</p>
                                    ...
                                    <div className="flex items-center gap-4 group/item">
                                        ...
                                        <div className="min-w-0">
                                            <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground/40">Voice Line</p>
                                    ...
                                    <div className="flex items-center gap-4 group/item">
                                        ...
                                        <div className="min-w-0">
                                            <p className="text-[9px] font-black uppercase tracking-widest text-muted-foreground/40">Geographic Hub</p>
                                            <p className="text-xs font-bold line-clamp-2 leading-relaxed">{supplier.address || "No address protocol"}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60">Trust Metrics</h4>
                                <div className="bg-primary/5 rounded-[1.5rem] p-5 border border-primary/10 space-y-3">
                                    <div className="flex items-center justify-between">
                                        <span className="text-[9px] font-black uppercase text-muted-foreground/60 italic">Reliability Ranking</span>
                                    ...
                                    <p className="text-[8px] text-muted-foreground/40 font-black uppercase tracking-widest">Top 5% of all supply nodes</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="glass-card rounded-[2.5rem] p-8 border border-primary/10 bg-emerald-500/5">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-500">Verified Node</span>
                        </div>
                        <p className="text-[11px] text-emerald-500/80 font-bold leading-relaxed">This supplier has been fully authenticated within the warehouse matrix rules.</p>
                    </div>
                </div>
                ...
                <div className="lg:col-span-3 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            { label: 'Asset Portfolio', value: products?.length || 0, icon: Boxes, color: 'text-primary' },
                            { label: 'Inventory Aggregate', value: products?.reduce((acc, p) => acc + p.stock_quantity, 0) || 0, icon: ShoppingBag, color: 'text-blue-500' },
                            { label: 'Capital Exposure', value: `$${totalStockValue.toLocaleString()}`, icon: Tag, color: 'text-emerald-500' }
                        ].map((stat, i) => (
                    ...
                    <div className="glass-card rounded-[3rem] border border-primary/10 overflow-hidden shadow-2xl">
                        <div className="px-10 py-8 border-b border-primary/10 bg-primary/[0.02] flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-black tracking-tight uppercase">Supplier Catalog</h3>
                                    <p className="text-[10px] text-muted-foreground/60 font-black tracking-widest uppercase mt-1 italic">Verified SKU portfolio</p>
                                </div>
                            </div>
                            ...
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="border-b border-primary/5">
                                        <th className="px-10 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60">SKU Description</th>
                                        <th className="px-6 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60">Category</th>
                                        <th className="px-6 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60 text-right">Acquisition</th>
                                        <th className="px-6 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60 text-center">Stock Node</th>
                                        <th className="px-10 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60 text-right text-destructive">Alert Status</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                            <td colSpan={5} className="py-24 text-center">
                                                <div className="flex flex-col items-center gap-4 opacity-20">
                                                    ...
                                                    <p className="text-[10px] font-black uppercase tracking-[0.3em]">No catalog data linked</p>
                                                </div>
                                            </td>
                                        </tr>
                                    ) : (
                                                ...
                                                <tr key={product.id} className="border-b border-primary/5 hover:bg-primary/[0.02] transition-colors group">
                                                    <td className="px-10 py-6">
                                                        <div className="flex items-center gap-4">
                                                            ...
                                                            <div className="flex flex-col min-w-0">
                                                                ...
                                                                <span className="text-[9px] font-mono font-bold text-muted-foreground/40 mt-0.5">{product.sku || 'SKU-UNSPECIFIED'}</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td className="px-6">
                                                    ...
                                                    <td className="px-6 text-center">
                                                        <div className="flex flex-col">
                                                            ...
                                                            <span className="text-[9px] font-black text-muted-foreground/30 uppercase">{product.unit || 'units'}</span>
                                                        </div>
                                                    </td>
                                                    <td className="px-10 text-right">
                                                        {isLow ? (
                                                            ...
                                                            <div className="flex items-center justify-end gap-2 text-emerald-500/40">
                                                                ...
                                                                <span className="text-[9px] font-black uppercase tracking-widest">Optimal Alpha</span>
                                                            </div>
                                                        )}
                                                    </td>
                                                </tr>
